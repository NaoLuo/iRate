...
static NSString *const iRateiOSAppStoreURLScheme = @"com.apple.TVAppStore";
...
static NSString *const iRateTVosAppStoreURLFormat = @"com.apple.TVAppStore://itunes.apple.com/app/id%@?action=write-review";
...
#elif TARGET_OS_TV
    URLString = iRateTVosAppStoreURLFormat;
#else
